...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { descripcion: @articulo.descripcion, name: @articulo.name, precio: @articulo.precio, stock: @articulo.stock, user_id: @articulo.user_id } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { descripcion: @articulo.descripcion, name: @articulo.name, precio: @articulo.precio, stock: @articulo.stock, user_id: @articulo.user_id } }
